package ch.bfh.ti.these.msp.util;
...
public final class Definitions {
    ...
    public final static int MAVLINK_GCS_COMP_ID = 1;


    public final static String BACKEND_HOST = "192.168.1.132";
    public final static int BACKEND_PORT = 8081;
}
